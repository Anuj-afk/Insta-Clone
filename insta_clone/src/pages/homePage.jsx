              ...
              <div className="flex-1  items-center flex justify-center">
                  ...
                  >
                    <div className="container row" style={{marginTop:'120px'}}>
                      {latestPost.results.map(({activity: {total_likes, total_views}, author: {personal_info: {fullname, profile_img, username}}, des, link, post_id, likes_hide, comment_hide}, id)=>(
                        <div className="col md-12" key={id} style={{marginBottom:'100px'}}>
                          <Post profile_img={profile_img} username={username} link={link} des={des} total_likes={total_likes} likes_hide={likes_hide} comment_hide={comment_hide} post_id = {post_id} id={id}/>
                        </div>
                      ))}
                    </div>
                  </InfiniteScroll>
